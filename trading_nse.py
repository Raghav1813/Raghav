...
# load chrome driver
# driver = webdriver.Chrome(executable_path="\Users\ragha\Downloads\.idea")
...
while True:
    ...
    if (current_time >= "09:30:00" and current_time < "15:10:00"):
        ...
        if (RSI >= 30 and RSI <= 70 and EMA == "BUY"):
            if (last_order == "sell"):
                print("Buying 1 stock of FRETAIL")
                last_order = "buy"
                print(last_order)
                print(sold_before)
                ...
                while True:
                    ...
                    current_price = driver.find_element(By.XPATH,
                                                        "//div[2]/div[8]/div[1]/div/div/div[1]/div[2]/div/div[2]/div[2]/div").text
                    if ((RSI >= 30 and EMA == "SELL") or (float(current_price) >= take_profit) or (
                            float(current_price) <= take_loss)):
                        # sell the stock
                        print("Selling 1 stock of FRETAIL")
                        last_order = "sell"
                        print(last_order)
                        # sell 1 stock of SONATSOFTW
                        driver.find_element(By.XPATH,
                                            "//body[1]/div[2]/div[8]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]").click()
                        time.sleep(2)
            ...
            if (last_order == "sell"):
                print("selling stock of FRETAIL")
                driver.find_element(By.XPATH,
                                    "//body[1]/div[2]/div[8]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]").click()
                time.sleep(2)
                driver.find_element(By.XPATH, "//button[1]/div[1]/span[2]").click()
                ...
                while True:
                    ...
                    if ((RSI <= 30 and EMA == "BUY") or (float(current_price) <= take_profit) or (
                        ...
                        driver.find_element(By.XPATH,
                                            "//div[8]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]").click()
                        driver.find_element(By.XPATH, "//div[1]/div[1]/div[6]/button[1]/div[1]/span[2]").click()
                        break
                    else:
                        print("no adjustment required")
        ...
        # #fetch open profit        open_profit = driver.find_element(By.XPATH, "//div[4]/div[1]/div[1]/div[1]/div[2]/div[3]/div[1]").text
        # print(open_profit)
        # P = "1000"
